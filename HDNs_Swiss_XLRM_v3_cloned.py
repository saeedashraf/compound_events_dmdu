...
### OR Let's make this function in a more OOP way: Sould be changed to the Policies for Health 
class Policy_Health:
...
def HDNs_Model (xRCP=None, xClimateModel=None, Xfactor1 = None, xCostDay = None, xRevenueDay = None,
    ...
    for k in range(len(caseStudyStns)):
        ...
        columnsDF.append('is_Tmax_Tmin_' + nameHeader)
        ...
        for i in range(len(totalFiles)):
            ...
            for j in range(len(df2ColCal)):
                ...
                #for i in range(3):
                    ...
                    'How to caéculate different length of concurrent HDNs'
                    PP = 0
                    for single_date in daterange(start_date, end_date):
...
if __name__ == '__main__':
    ...
    model.levers = [
                    RealParameter("x1TmaxThershold", 22.0, 23.0),
                    RealParameter("x2TminThershold", 9.0, 9.5)]
...
save_results(results, r'C:\Saeid\Prj100\SA_11_HDNS\case2_Basel\setup1\32_runs.tar.gz')
print('end!')
