...
##Here we calcluate seasonal tipping points here
        ...
        #return {'S_Ave_GoodDay' : AveragesumRows, 'GCM_RCM' : climateModel, 'y2' : dfpcpCol[climateModel], 'S_GoodDay' : sumRows, 'S_Length_events' : indexLength }
...
if __name__ == '__main__':
    ...
    #model.constants = [Constant("xCostDay", 6),
